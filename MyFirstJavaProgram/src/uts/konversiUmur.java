...
public class konversiUmur {
  ...
  public static String hitungUmur(String tanggalLahir, String tanggalSekarang) {
    ...
    int hariDariLahir = (tahunLahir * 365) + (bulanLahir * 30) + hariLahir;
    ...
    int hariDariSekarang = (tahunSekarang * 365) + (bulanSekarang * 30) + hariSekarang;

    int selisihHari = hariDariSekarang - hariDariLahir;

    int umurTahun = selisihHari / 365;
    selisihHari = selisihHari % 365;
