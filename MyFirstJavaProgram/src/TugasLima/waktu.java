...
/*
 ! Pseudocode program !
 * 1. Program start
 * 2. Deklarasi variabel(jamAwal, jamAkhir, menitAwal, menitAkhir, detikAwal, detikAkhir)
 * 3. Input data(masukkan waktu mulai(jj:mm:dd), masukkan waktu selesai(jj:mm:dd));
 * Proses data(mengambil bagian tertentu dari string untuk mengambil waktu jam, menit, dan detik)
 * 4. Proses data(jamHasil = (jamAkhir - jamAwal), menitHasil = (menitAkhir - menitAwal), detikHasil = (detikAkhir - detikAwal));
 * 5. Output data(jamHasil, menitHasil, detikHasil);
 * 6. Program end
 */
